...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await Target.send({embeds: [new MessageEmbed().setColor("GOLD").setTitle("🦶 Вы были **выгнаны** с сервера").setTimestamp()
        ...
        const Embed = new MessageEmbed().setTitle("Успешнное изгнание с сервера!")
