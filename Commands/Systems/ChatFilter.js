    ...
    options: [
        ...
        { name: "list", description: "Список слов в черном списке.", type: "SUB_COMMAND" },
        {
            ...
            options: [
                {
                    name: "logging",
                    description: "Выберите канал логгирования.",
                    type: "CHANNEL",
        ...
        },
        {
            ...
            options: [
                ...
                {
                    name: "word",
                    description: "Укажите слово, добавьте несколько слов, поставив запятую между ними (слово, другоеслово)",
                    type: "STRING",
                    required: true
                }
            ]
    ...
    async execute(interaction, client) {
        ...
        switch(subCommand) {
            ...
            case "settings" : {
                ...
                interaction.reply({content: `Добавлен <#${loggingChannel}> в качестве канала логгирования для системы фильтрации.`, ephemeral: true});
            }
            break;
            case "configure" : {
